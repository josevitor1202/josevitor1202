...
Estudante de **Engenharia Física na UFSCar** com foco em transformar fenômenos físicos em soluções computacionais eficientes. Utilizo a programação como ferramenta principal para modelagem, simulação e otimização de sistemas complexos.
